...
export const Route = createFileRoute("/markets")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Every company listed in your TTI portfolio with quantity, average cost, last traded price and profit or loss." },
      { property: "og:title", content: "Portfolio Companies — TTI" },
      { property: "og:description", content: "Sector-wise listing of your holdings with live LTP and P&L across NSE and BSE." },
    ],
  }),
  component: Markets,
});
  ...
  return (
    <Shell>
      <div className="mb-3 flex items-center justify-between">
        ...
        <span className="font-mono text-[10px] uppercase tracking-[0.15em] text-muted-foreground">{holdings.length} instruments</span>
      </div>
      ...
      <Panel title="Listed Companies" tag="(a)" meta="LIVE · NSE / BSE">
        ...
        <div className="divide-y divide-line">
          {holdings.map((h) => {
            ...
            return (
              <button key={h.symbol} type="button" onClick={() => selectStock(h.symbol)} className="grid w-full cursor-pointer grid-cols-12 items-center px-4 py-3 text-left transition-colors hover:bg-white/[0.04] focus:bg-white/[0.06] focus:outline-none" aria-label={`Select ${h.symbol}`}>
      ...
      <div className="mt-5 grid grid-cols-12 gap-5">
        <div className="col-span-12 lg:col-span-6"><Panel title="Market Movers" tag="(b)" meta="TOP GAINERS"><div className="divide-y divide-line">
        ...
        <div className="col-span-12 lg:col-span-6"><Panel title="Watchlist" tag="(c)" meta="MY STOCKS"><div className="divide-y divide-line">
